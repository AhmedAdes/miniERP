...
router.get('/', function (req, res, next) {
    ...
    request.query(`SELECT fr.*, u.UserName FROM dbo.FinishedReceiving fr JOIN dbo.SystemUsers u ON u.UserID = fr.UserID`)
    ...
    connection.connect().then(function () {
        ...
        trans.begin()
            .then(function () {
                ...
                request.input('ReceivedFrom', finrec.ReceivedFrom);
                request.input('UserID', finrec.UserID);
                request.execute('FinishReceivingUpdate').then(function (recordset, returnValue, affected) {
